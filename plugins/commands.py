...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, AUTH_USERS, SHORT_USERS
...
@Client.on_message(filters.command("shortlink") & filters.user(SHORT_USERS))
async def shortlink(bot, message):
    ...
    if user.status != enums.ChatMemberStatus.ADMINISTRATOR and user.status != enums.ChatMemberStatus.OWNER and str(userid) not in SHORT_USERS:
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\nGive me a shortlink and api along with the command !\n\nFormat: <code>/shortlink paisakamalo.in 6086cbf95a47bcf0a85c5f75d40eed90688124a0</code></b>")
