...
PICS = (environ.get('PICS', 'https://telegra.ph/file/e5aac302dac865ab8cdab.jpg')).split()
...
short_users = [int(user) if id_pattern.search(user) else user for user in environ.get('SHORT_USERS', '').split()]
SHORT_USERS = (short_users + ADMINS + AUTH_USERS) if auth_users else []
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "📂Fɪʟᴇɴᴀᴍᴇ: <code>{file_name}</code> \n\n🎬𝙼𝙾𝚅𝙸𝙴 𝙶𝚁𝙾𝚄𝙿🍿: \n[✪𝚂𝙽𝚂 𝙼𝙾𝚅𝙸𝙴𝚂✪](https://t.me/+7j7EXi8FELQ2MjU9)</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "🗂️Fɪʟᴇɴᴀᴍᴇ: <code>{file_name}</code> \n\n🎬𝙼𝙾𝚅𝙸𝙴 𝙶𝚁𝙾𝚄𝙿🍿: \n[✪𝚂𝙽𝚂 𝙼𝙾𝚅𝙸𝙴𝚂✪](https://t.me/+7j7EXi8FELQ2MjU9)</b>")
